...
- When a task closes a phase, run `pnpm format:check` at the repo root and treat a failure as blocking.
...
- 2026-03-10 - Task 1.3 - Added the phase-close `pnpm format:check` requirement to the shared delivery-governance quick rules.
