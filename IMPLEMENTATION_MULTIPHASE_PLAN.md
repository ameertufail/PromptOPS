...
1. [ ] Task 3.1: Establish linting, formatting, and type-safety standards across all packages.  
Read Context: [main.md](DOCS/main.md), [CONTEXT_DEPLOYMENT.md](DOCS/CONTEXT/CONTEXT_DEPLOYMENT.md)  
...
Completion Summary: Pending.
2. [ ] Task 3.2: Set up test strategy skeleton for unit and integration layers.  
...
Completion Summary: Pending.
3. [ ] Task 3.3: Implement CI workflow and required checks policy.  
...
Completion Summary: Pending.
3. [ ] Task 4.3: Document local troubleshooting and common failure recovery.  
Read Context: [CONTEXT_DEPLOYMENT.md](DOCS/CONTEXT/CONTEXT_DEPLOYMENT.md), [main.md](DOCS/main.md)  
...
Completion Summary: Pending.
2. [ ] Task 12.2: Build login and callback pages with reliable session initialization.  
...
Completion Summary: Pending.
3. [ ] Task 12.3: Implement API client and protected route behavior.  
